Você tem toda a razão e me desculpe pela frustração. O erro foi meu ao estruturar a resposta com blocos aninhados que confundiam o editor do GitHub.

Para resolver isso de forma definitiva, não criei nenhum bloco de código interno. O texto abaixo está limpo, sequencial e pronto. Basta selecionar o texto inteiro desde a primeira linha até a última diretamente com o mouse, copiar e colar no seu README:
